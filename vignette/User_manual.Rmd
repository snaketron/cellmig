...
In this vignette we will use simulated data from:
  ...
  * the wells are treated with **compounds** c1, c2, ..., c4 at 
   **dose** d1, d2, ..., d7. Each pair of a compound and dose 
  is considered as a treatment group: c1|d1, c2|d2, ... etc.
...
get_treatment_profile(x = o,
                      hc_link = "average",
                      hc_dist = "euclidean",
                      select_gs = get_groups(o)$group[1:5],
                      B = 1000)
```
